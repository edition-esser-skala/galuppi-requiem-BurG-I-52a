...
ChristeSopranoNotes = {
  \relative c' {
    ...
    h c d
    e([ fis)] g
    \appoggiatura fis32 e16([ d32 c)] h8 a
    g r r
    R4.*7 %131
    d'8.([ c16)] h8
    \appoggiatura d16 c8 h a
...
IudexErgoSopranoLyrics = \lyricmode {
  \xE Iu -- dex %291
  er -- go
  cum se --
  de -- bit,
...
LacrimosaSopranoLyrics = \lyricmode {
  La -- cri -- %907
  mo -- sa di -- es il -- la, di --
  es il -- la,
  \xE qua re -- sur -- get, %910
  qua re -- sur -- get
  ex fa -- vil --
  la,\x ju -- di -- can --
  dus ho -- mo re --
