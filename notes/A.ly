...
IntroitusAltoNotes = {
  \relative c' {
    ...
    \cadenzaOn f2 g f1*1/2 f2 \cadenzaOff \bar "||"
...
TeDecetAltoNotes = {
  \relative c' {
    ...
    \cadenzaOn f2 g g f g a a a a a a g a \cadenzaOff \bar "||"
...
TeDecetAltoLyrics = \lyricmode {
  Te _ de -- _ cet _ hy -- mnus, De -- us in Si -- on.
  \xE Et %14
  ti -- bi red -- %15
  de -- tur
  vo -- tum in
...
KyrieAltoNotes = {
  \relative c' {
    ...
    es8. d16 d4 \appoggiatura a'16 g8 f16([ e)] f8 f
